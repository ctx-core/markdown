 ...
 * @returns {Function}
 */
export function _get_segment_a1(opts) {
    const { dir } = opts;
    return async (req, res) => {
        const { params } = req;
        // params.segment_a1
        const segment_a1 = params.segment_a1;
        ...
        const resolve_md_file_path_txt = await _resolve_md_file_path_txt(`${resolve_source_path}.md`);
